  ...
  <Block>
    ...
    <section>
      ...
      <section className="stage">
        <H3>Нулевой этап: подготовка (до 18 июня)</H3>
        <div className="list">
          <p>
      ...
      <section className="stage">
        <H3>Первый: вёрстка (19 — 25 июня)</H3>
        <div className="list">
          <p>
      ...
      <section className="stage">
        <H3>Второй: Реакт (26 июня — 2 июля)</H3>
        <p>
      ...
      <section className="stage">
        <H3>Четвёртый: джаваскрипт (10 — 16 июля)</H3>
        <div className="list">
